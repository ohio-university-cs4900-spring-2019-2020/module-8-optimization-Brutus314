...
#include <vector>
#include <memory>
#include "GLViewFrustumCulling.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewFrustumCulling > glView( Aftr::GLViewFrustumCulling::New( args ) );
